...
public class CoinFlipMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        for (int i=0; i<19; i++){
            buttons.putIfAbsent(i, Button.placeholder(Material.RED_STAINED_GLASS_PANE, (byte) 15, " "));
        }

        buttons.put(26, Button.placeholder(Material.RED_STAINED_GLASS_PANE, (byte) 15, " "));
        buttons.put(36, Button.placeholder(Material.RED_STAINED_GLASS_PANE, (byte) 15, " "));
        buttons.put(45, Button.placeholder(Material.RED_STAINED_GLASS_PANE, (byte) 15, " "));

        for (int i=46; i<54; i++){
            buttons.put(i, Button.placeholder(Material.RED_STAINED_GLASS_PANE, (byte) 15, " "));
        }
