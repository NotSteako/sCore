...
public class KillstreakReward {
    ...
    public static ItemStack GRANDMA_SOUP = new ItemBuilder(Material.MUSHROOM_STEW).enchantment(Enchantment.UNBREAKING, 1).name(CC.translate("&aGrandma Soup")).build();
